...
| J20 | startup-truth-and-validation | Moderate | 🟡 **Mostly built 2026-08-06 — STV-1/3/4/5 landed; STV-2/6 remain.** Boot validates what the run will need (LLM config, nullable allowlists) and the banner reports the *effective* engine, not configured intent — the FND-49/FND-36 class, re-opened | J1, J2, J8 |
