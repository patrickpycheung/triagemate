> # 🗄️ ARCHIVED — Forge/Rovo track (retired)
> This was the project's **original** README, describing an Atlassian Forge Rovo-agent
> prototype. That approach was **retired** in favour of a local **Spring Boot + Google
> ADK** app. It is kept here for historical reference only — **do not follow these
> instructions**. The active build and how-to-run live in the root
> [`README.md`](../../README.md) and [`app/README.md`](../../app/README.md); the pivot
> rationale is in [`PIVOT.md`](../../PIVOT.md).

---

# ServiceNow Triage Assistant (archived — Forge/Rovo track)
