...
| **J5** | **servicenow-gateway** | Read incident + similar incidents + CMDB/ownership; **automatic advisory work-note write** (idempotent, labelled; the confirm gate was removed 2026-07-23 — see J5/J8). | Moderate | RC5 |
